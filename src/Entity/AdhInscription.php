...
use App\Repository\AdhInscriptionRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Validator\Constraints as Assert;

#[ORM\Entity(repositoryClass: AdhInscriptionRepository::class)]
#[ORM\Table(name: "Adh_Inscription")]
class AdhInscription
{
    private const NOTBLANK_MESSAGE = 'Ce champ ne peut pas être vide.';

 
    #[ORM\ManyToOne(inversedBy: 'adhInscriptions')]
