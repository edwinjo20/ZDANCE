...
#[ORM\Table(name: "adherents", indexes: [
    new ORM\Index(name: "idx_nom_adh", columns: ["nom_adh", "prenom_adh"]) // ✅ Ajout de l'index composite
])]
...
class Adherents
{
    ...
    #[ORM\OneToOne(targetEntity: Users::class, inversedBy: "adherent")]
    #[ORM\JoinColumn(name: "id_users", referencedColumnName: "id_user", unique: true)]
...
private ?string $indexAdh = null;
     ...
     /**
     * Relation avec la table de liaison AdhCours (OneToMany)
     */
  

    #[ORM\OneToMany(targetEntity: AdhInscriptionPaiement::class, mappedBy: 'adherent')]
    private Collection $paiements;

    #[ORM\OneToMany(targetEntity: AdhInscription::class, mappedBy: 'adherent')]
    private Collection $inscriptions;

    #[ORM\OneToMany(targetEntity: Alertes::class, mappedBy: 'adhIndexAlt')] // Utilisez le nom de la propriété dans Alertes
    ...
    public function setIndexAdh(?string $indexAdh): static
    {
        ...
        /**
     * @return Collection<int, AdhInscriptionPaiment>
     */
    public function getPaiements(): Collection
    {
        ...
        /**
     * @return Collection<int, AdhInscriptionPaiement>
     */
